const translations: Record<string, Record<string, string>> = {
    en: {
        ...
        proj1_library: "Hardware: Stepper Motors, Gripper",
        proj1_architecture: "Features: Real-time control, Trajectory memory",
        proj1_stateManager: "Control Mode: Manual & Auto",
        ...
        proj3_paragraph: "AI_EmailAgent is an intelligent, CLI-based Executive Email Assistant designed to help you manage your Gmail inbox efficiently. Operating under the persona of a concise assistant, it combines the Gemini API with direct Gmail integration to proactively summarize threads, sort incoming mail, and draft contextual responses.",
        proj3_lang: "Language: Python 3.x",
        proj3_ai: "AI Engine: Google GenAI SDK (Gemini)",
        proj3_integration: "Email Integration: Google Workspace Gmail API",
        proj3_tools: "Architecture: Custom Tool Calling",
    ...
    pl: {
        ...
        proj1_architecture: "Funkcjonalności: Kontrola w czasie rzeczywistym, Pamięć trajektorii",
        proj1_stateManager: "Tryb sterowania: Manualny i Automatyczny",
        ...
        proj3_paragraph: "AI_EmailAgent to inteligentny asystent e-mail działający w interfejsie CLI, zaprojektowany, aby pomóc Ci w wydajnym zarządzaniu skrzynką odbiorczą Gmail. Działając jako zwięzły asystent, łączy on interfejs API Gemini z bezpośrednią integracją z Gmailem w celu proaktywnego podsumowywania wątków, sortowania poczty i redagowania trafnych odpowiedzi.",
        proj3_lang: "Język programowania: Python 3.x",
        proj3_ai: "Silnik AI: Google GenAI SDK (Gemini)",
        proj3_integration: "Integracja z e-mailem: Google Workspace Gmail API",
        proj3_tools: "Architektura: Niestandardowe wywoływanie narzędzi (Tool Calling)",
    ...
    ua:{
        ...
        proj1_architecture: "Функціонал: Контроль у реальному часі, Пам'ять траєкторій",
        proj1_stateManager: "Режим керування: Ручний та Автоматичний",
        ...
        proj3_paragraph: "AI_EmailAgent — це розумний поштовий асистент із командним інтерфейсом (CLI), створений для ефективного керування вашою поштовою скринькою Gmail. Працюючи як лаконічний помічник, він поєднує Gemini API з прямою інтеграцією Gmail для проактивного узагальнення листувань, сортування пошти та створення контекстних відповідей.",
        proj3_lang: "Мова програмування: Python 3.x",
        proj3_ai: "ШІ Двигун: Google GenAI SDK (Gemini)",
        proj3_integration: "Інтеграція з поштою: Google Workspace Gmail API",
        proj3_tools: "Архітектура: Користувацький виклик інструментів (Tool Calling)",
