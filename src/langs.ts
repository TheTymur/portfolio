const translations: Record<string, Record<string, string>> = {
    ...
    ua:{
        ...
        aboutMe_paragraph: "Я програміст та студент Краківської політехніки, який прагне будувати міст між складними даними та захопливим користувацьким досвідом. Моя робота натхненна фасцинацією логікою, що стоїть як за сучасними системами, так і за складними іграми. Саме це спонукало мене спеціалізуватися на штучному інтелекті, машинному навчанні та аналізі даних",
